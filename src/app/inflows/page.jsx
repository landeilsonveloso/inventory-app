        ...
        <AuthProvider>
            <Div className="text-white min-h-screen bg-black">
                <Div className="flex justify-between items-center mb-6">
                    <Title>Entrada: {formatToBRL(filtered.reduce((sum, item) => sum + (parseFloat(item.firstValue) + parseFloat(item.secondValue) + parseFloat(item.thirdValue)), 0))}</Title>
                ...
                {isOpen && tag === "Create" ? (
                    <Modal>
                        <Form onSubmit={createInflow}>
                            ...
                            <Title className="text-center mb-4 text-xl font-bold">Novo Entrada</Title>
                            ...
                            <Div className="space-y-4">
                                ...
                                <Div className="flex items-center border rounded-lg p-2 mt-1">
                                    ...
                                    <Select className="w-full p-0.5 cursor-pointer bg-transparent outline-none" onChange={(e) => setFirstMethod(e.target.value)}>
                                        <Option value=""></Option>
                            ...
                            {showSecondMethod ? (
                                <Div className="mt-1 pt-4">
                                    ...
                                    <Div className="flex items-center border rounded-lg p-2 mt-1 mb-4">
                                        ...
                                        <Select className="w-full p-0.5 cursor-pointer bg-transparent outline-none" onChange={(e) => setSecondMethod(e.target.value)} >
                                            <Option value=""></Option>
                                            <Option value="Cartão">Cartão</Option>
                                            <Option value="Espécie">Espécie</Option>
                                            <Option value="Pix">Pix</Option>
                            ...
                            {showThirdMethod ? (
                                <Div className="mt-1 pt-4">
                                    ...
                                    <Div className="flex items-center border rounded-lg p-2 mt-1 mb-4">
                                        ...
                                        <Select className="w-full p-0.5 cursor-pointer bg-transparent outline-none" onChange={(e) => setThirdMethod(e.target.value)} >
                                            <Option value=""></Option>
                                            <Option value="Cartão">Cartão</Option>
                                            <Option value="Espécie">Espécie</Option>
                                            <Option value="Pix">Pix</Option>
                            ...
                            <Div className="flex justify-end gap-4 mt-6">
                                ...
                                <Button className={`flex justify-center w-28 bg-green-600 text-white py-2 rounded transition ${disabledInflowsButton ? "cursor-default opacity-70" : "hover:bg-green-800 cursor-pointer"}`} disabled={disabledInflowsButton}>
                                    {disabledInflowsButton ? <Spinner/> : <>Adicionar</>}
                                </Button>
                            </Div>
                        </Form>
                    </Modal>
                ...
                {isOpen && tag === "Edit" ? (
                    <Modal>
                        <Form onSubmit={updateInflow}>
                            ...
                            <Title className="text-center mb-4 text-xl font-bold">Editar Entrada</Title>
                            ...
                            <Div className="space-y-4">
                                ...
                                <Div className="flex items-center border rounded-lg p-2 mt-1">
                                    ...
                                    <Select className="w-full p-0.5 cursor-pointer bg-transparent outline-none" value={firstMethod} onChange={(e) => setFirstMethod(e.target.value)}>
                                        <Option value=""></Option>
                                        <Option value="Cartão">Cartão</Option>
                                        <Option value="Espécie">Espécie</Option>
                                        <Option value="Pix">Pix</Option>
                            ...
                            {showSecondMethod ? (
                                <Div className="mt-1 pt-4">
                                    ...
                                    <Div className="flex items-center border rounded-lg p-2 mt-1 mb-4">
                                        ...
                                        <Select className="w-full p-0.5 cursor-pointer bg-transparent outline-none" value={secondMethod} onChange={(e) => setSecondMethod(e.target.value)}>
                                            <Option value=""></Option>
                                            <Option value="Cartão">Cartão</Option>
                                            <Option value="Espécie">Espécie</Option>
                                            <Option value="Pix">Pix</Option>
                            ...
                            {showThirdMethod ? (
                                <Div className="mt-1 pt-4">
                                    ...
                                    <Div className="flex items-center border rounded-lg p-2 mt-1 mb-4">
                                        ...
                                        <Select className="w-full p-0.5 cursor-pointer bg-transparent outline-none" value={thirdMethod} onChange={(e) => setThirdMethod(e.target.value)}>
                                            <Option value=""></Option>
                                            <Option value="Cartão">Cartão</Option>
                                            <Option value="Espécie">Espécie</Option>
                                            <Option value="Pix">Pix</Option>
                            ...
                            <Div className="flex justify-end gap-4 mt-6">
                                ...
                                <Button className={`flex justify-center w-28 bg-blue-600 text-white py-2 rounded transition ${disabledInflowsButton ? "cursor-default opacity-70" : "hover:bg-blue-800 cursor-pointer"}`} disabled={disabledInflowsButton}>
                                    {disabledInflowsButton ? <Spinner/> : <>Salvar</>}
                                </Button>
                            </Div>
                        </Form>
                    </Modal>
                        ...
                        <Form className="flex flex-col" onSubmit={deleteInflow}>
                            ...
                            <Div className="text-center text-xl mt-4 mb-8">
                             ...
                             <Div className="flex justify-end gap-3">
                                ...
                                <Button className={`flex justify-center w-20 bg-red-600 text-white py-2 rounded transition ${disabledInflowsButton ? "cursor-default opacity-70" : "hover:bg-red-800 cursor-pointer"}`} disabled={disabledInflowsButton}>
                                    {disabledInflowsButton ? <Spinner/> : <>Excluir</>}
                                </Button>
                            </Div>
                        </Form>
                    </Modal>
